class Money
	...
	def + money_to_be_added
		new_value=
		self.value*@@conversion_table[self.currency] + money_to_be_added.value*@@conversion_table[money_to_be_added.currency]
	...
	describe Money do
		...
		describe "addition of money" do
			...
			it "should create a new money object with a value as sum of given values when
			 two money objects of same currency are added for different values" do
			...
			it "created a new money object should not have value as sum of given values when
			 two money objects of different currency are added for different values" do
			 money1 = Money.new(7,'INR')
		...
		describe "equality and conversion" do
			it "treats two money objects of same value and currency as equal" do
				money1=Money.new(10,'INR')
				money2=Money.new(10,'INR')
				expect(money1==money2).to eq true
			end
			it "treats two money objects of different value and different currency as equal if 
			the conversion satisfies" do
